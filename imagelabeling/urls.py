...
urlpatterns = [
    ...
    path('model/<int:ml_model_id>/image/<int:image_id>/', views.image_label_detail, name='detail'),
    ...
    path('model/<int:ml_model_id>/label/<int:image_id>/Relabelvote', views.Relabelvote, name='Relabelvote'),
    path('model/<int:ml_model_id>/label/<int:image_id>/RelabelvoteHome', views.RelabelvoteHome, name='RelabelvoteHome'),
    # path('model/<int:ml_model_id>/a/', views.GetAlpha, name='ask user for alpha'),
    path('model/<int:ml_model_id>/s/', views.userTuneRidge, name='show alpha '),
